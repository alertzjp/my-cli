   ...
   <div class="heanderFixed" v-if="show">
     <Form ref="maintainSite" :model="maintainSite" :label-width="100" :rules="ruleValidate">
         <Row>
             ...
             <Col :xs="24" :sm="24" :md="24" :lg="24">
                 <FormItem label="维修站点地区" prop="name">
             ...
             <Col :xs="24" :sm="24" :md="24" :lg="24">
                 <FormItem label="站点负责人">
                    <div class="" v-if="parentshow">
                        {{maintainSite.principalsName}}   <Button type="primary" @click="edit()">编辑</Button>
                    </div>
                    <div class="" v-else>
...
export default {
  ...
  methods: {
    ...
    list () {
      ...
      this.$api.get('/maintainsite/findOne',listdata,reset => {
        _this.loading = false
        if (reset.codeId === 1) {
          ...
          _this.maintainSite.id = reset.resData.id
          _this.maintainSite.maintainSiteName = reset.resData.maintainSiteName
          _this.maintainSite.provinceCode = reset.resData.provinceCode
          _this.maintainSite.cityCode = reset.resData.cityCode
          _this.maintainSite.countyCode = reset.resData.countyCode
          _this.maintainSite.address = reset.resData.address
          _this.maintainSite.Longitude = reset.resData.longitude
          _this.maintainSite.Latitude = reset.resData.latitude
          ...
          _this.maintainSite.principalsId = reset.resData.principalsId
          _this.maintainSite.principalsName = reset.resData.principalsName
          _this.show = true
        }else {
  ...
  addpost () {
      ...
      if(this.maintainSite.principalsId!==""){
          listdata.data.maintainSite.principalsId = this.maintainSite.principalsId
      }
