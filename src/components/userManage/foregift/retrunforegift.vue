     ...
     <div class="tableListForm">
       <Form ref="formCustom" :model="formCustom" :label-width="70">
           <Row>
             ...
             <Col :xs="24" :sm="12" :md="8" :lg="6" :xl="6" :xxl="4">
               <FormItem label="退款状态">
                 <Select v-model="formCustom.tradeStatus" placeholder="请选择退款状态">
               ...
               <Col :xs="24" :sm="12" :md="8" :lg="6" :xl="6" :xxl="4">
                  <FormItem label="退款方式">
                    <Select v-model="formCustom.tradeType" placeholder="请选择退款方式">
                       <Option value="">全部</Option>
...
<script>
  ...
  mounted() {
    ...
    this.$vm.$on("callbackEnter",(e)=>{
      if(_this.$route.path == "/admin/userManage/retrunforegift"){
        _this.handleSubmit()
      }
    })
  },
  methods: {
    ...
    list () {
      ...
      let _this =  this
      this.$api.get('/bicycleRefund/list',listdata,reset => {
        if (reset.codeId === 1) {
