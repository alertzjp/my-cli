   ...
   <div class="page-component-bd">
    <Row>
     <Col :xs="24" :sm="24" :md="12" :lg="12">
        ...
        <FormItem label="卡费" prop="amount">
            <Input v-model="formValidate.amount" placeholder="请输入卡费"></Input>
        </FormItem>
...
export default {
  ...
  data () {
    return {
      ...
      ruleValidate: {
            ...
            amount: [
              { required: true, message: '卡费没有填写', trigger: 'blur' },
              { type: 'string', min:1,max:50, message: '最小2个字符，最多50字符', trigger: 'blur' }
            ],
            foregift: [
  ...
  methods: {
   ...
   post () {
     ...
     let _this =  this
     this.$api.post('/universalCard/add',listdata,reset => {
         if (reset.codeId === 1) {
             _this.$router.push({
