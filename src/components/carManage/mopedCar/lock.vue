       ...
       <div style="text-align:left;">
         <Form ref="formValidate" :model="formCustom"  :label-width="100">
             <Row>
               ...
               <Col :xs="24" :sm="24" :md="24" :lg="12">
                 <div class="">
                   <FormItem label="开锁类型:" prop="purchase_order_no">
                     <Select v-model="unlockHandleBarType">
                         <Option value="1">租用开锁</Option>
                         <Option value="2">维护开锁</Option>
                         <Option value="9">特殊情况开锁</Option>
                     </Select>
                   </FormItem>
                 </div>
               </Col>
    ...
    ok() {
      ...
      let data = {
        data:JSON.stringify({
          ...
          unlockHandleBarType:this.unlockHandleBarType,
          id:this.formCustom.id
        })
      }
      this.$api.post('/bike/unlockhandlebar',data,reset => {
          if (reset.codeId === 1) {
