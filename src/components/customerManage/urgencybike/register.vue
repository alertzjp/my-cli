    ...
    <Modal v-model="show" width="500" @on-cancel="cancel" :mask-closable="false">
       ...
       <div style="text-align:left">
         <Form ref="formValidate" :model="formValidate" :rules="ruleValidate"  :label-width="80">
              ...
              <FormItem label="租车用户" prop="callMobile">
                 <rentcarComponent @rentcarEmit="rentcarEmit"></rentcarComponent>
            ...
            <FormItem>
                <Button type="primary" :loading="loading" @click="handleSubmit('formValidate')">新增</Button>
