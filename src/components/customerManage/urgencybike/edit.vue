      ...
      <Form ref="formCustom" :model="formCustom" :rules="ruleValidate" :label-width="80">
        ...
        <FormItem label="解决状态:" required>
          ...
          <FormItem label="站点:" required>
              <site-component @EmitDocksiteComponent="EmitDocksiteComponent" type="2" :siteId="formCustom.outSiteId" v-if="show"></site-component>
          </FormItem>
          <FormItem label="描述:">
  ...
  data () {
    return {
      ...
      formCustom:{
        id:"",
        districtId:'',
        fastFlag:'2',//1.非急修，2.急修
        solveFlag:'0', // 0未解决，1.解决
        docksiteNo:'',
        detail:'',
        docksiteName:''
      },
