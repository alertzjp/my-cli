<template>
  <div class="page-component-view">
   <div class="page-component-bd">
    ...
    <putin-component v-if="putinshow" :setitem="setitem"  @emitputincomponent="emitputincomponent"></putin-component>
   </div>
</template>
<script>
import tableComponent from '../../pub/tablecommon.vue'
import pageComponent from '../../pub/page.vue'
import putinComponent from './putin.vue'
