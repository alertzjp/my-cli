...
<template>
  <div class="">
    <Select v-model="docksitedatavalue" @on-change="dearleSelect(docksitedatavalue)" @on-query-change='searchQueryChange' filterable placeholder="选择站点" v-if="type==1">
    ...
    <Select v-model="docksitedatavalue" @on-change="dearleSelect01(docksitedatavalue)" @on-query-change='searchQueryChange01' filterable placeholder="选择站点" v-if="type==3">
        <Option value="" >全部</Option>
