<template>
  <div id="">
    <Modal v-model="show" width="900" :mask-closable="false" @on-cancel="cancel" :fullscreen="fullscreen">
      <div slot="header">
        【{{formCustom.time}}】明细列表
...
export default {
  ...
  methods: {
    ...
    list () {
      ...
      let _this =  this
      this.$api.get('/statistic/rent_day_detail',listdata,reset => {
        if (reset.codeId === 1) {
