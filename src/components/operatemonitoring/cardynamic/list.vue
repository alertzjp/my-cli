                  ...
                  return h('div', [
                     h('Button', {
                        ...
                        on: {
                            click: () => {
                              _this.$router.push({
                                path:"/admin/operatemonitoring/cardynamic/view",
                                query:{
                                  id:params.row.id
                                }
                              })
                      ...
                      h('Button', {
                          ...
                          on: {
                              click: () => {
                                _this.$router.push({
                                  path:"/admin/operatemonitoring/cardynamic/map",
                                  query:{
                                    terminalNo:params.row.terminalNo
                                  }
                                })
                              }
                          }
  ...
  methods: {
   ...
   timeEmit(e){
    ...
    list () {
      ...
      let _this =  this
      this.$api.get('/dynamicinfo/list',listdata,reset => {
        if (reset.codeId === 1) {
