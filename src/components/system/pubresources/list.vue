  ...
  <div class="page-component-view">
   <div class="page-component-bd">
     ...
     <div class="tableListOperator">
       <Buttoncomponent title="新增"  icon="md-add" @emitButton="addrole" v-if="$hasPerm('/pub_resources/save')"></Buttoncomponent>
     </div>
     <Row>
   ...
   <editrole-component v-if="editroleshow" :selectitem="selectitem" :editroleshow="editroleshow" @emitrolecomponent="emitrolecomponent"></editrole-component>
   </div>
</template>
<script>
...
import Pages from '../../pub/page.vue'
                ...
                let _this = this;
                  return h('div', [
                      h('Button', {
                          ...
                          style: {
                              marginRight: '5px',
                              display:_this.$hasPerm('/pub_resources/update')?"":"none"
                           },
                          on: {
                              click: () => {
                      ...
                      h('Button', {
                          ...
                          style: {
                              marginRight: '5px',
                              display:_this.$hasPerm('/pub_resources/delResources')?"":"none"
                           },
                          on: {
                              click: () => {                                 
  ...
  methods: {
    ...
    delrole (e) {
      ...
      let _this = this;
      this.$api.post('/pub_resources/delResources',listdata,reset => {
        if (reset.codeId === 1) {
    ...
    list () {
      ...
      let _this =  this
      this.$api.get('/pub_resources/list',listdata,reset => {
        _this.loading = false
        if (reset.codeId === 1) {
