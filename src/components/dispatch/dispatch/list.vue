  ...
  <div class="page-component-view">
   <div class="page-component-bd">
           ...
           <Row>
               <Col :xs="24" :sm="12" :md="8" :lg="6" :xl="6" :xxl="4">
                  <FormItem label="负责人名称">
                    <Input type="text" v-model="formCustom.maintainerName" placeholder="请输入负责人名称"></Input>
                  </FormItem>
               </Col>
               <Col :xs="24" :sm="12" :md="8" :lg="6" :xl="6" :xxl="4">
    ...
    <div class="tableListOperator">
      ...
      <Buttoncomponent title="导出"  type="success" icon="md-arrow-down" @emitButton="exportfile" v-if="$hasPerm('/bicycle_dispatch_sheet/export')"></Buttoncomponent>
     </div>
     <Row>
...
export default {
  ...
  mounted() {
    ...
    this.$vm.$on("callbackEnter",(e)=>{
      if(_this.$route.path == "/admin/dispatch/dispatch/list"){
        _this.handleSubmit()
      }
    })
  },
